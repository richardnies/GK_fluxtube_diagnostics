...
| `plot_zonal_upar_vE_kx.py` | `scan_config.py`* | E_RH(kx) (log) + zonal upar/vE and upar*cos(theta)/vE ratios vs kx (left column), plus zonal vE/upar/upar*cos(theta) profiles vs x (right column), multi-run |
